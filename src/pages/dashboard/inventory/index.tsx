      ...
      <div style={{ padding: '0 1rem' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem', flexWrap: 'wrap', gap: '1rem' }}>
          <div>
            <h1 style={{ fontSize: '1.5rem', fontWeight: '700', color: COLORS.textPrimary, margin: 0 }}>
              <FontAwesomeIcon icon={faWarehouse} style={{ color: COLORS.primary, marginRight: '0.5rem' }} />
              {t('inventoryPortal') || 'Inventory Portal'}
            </h1>
            <p style={{ fontSize: '0.85rem', color: COLORS.textSecondary, margin: '0.15rem 0 0 0' }}>
              {t('manageInventory') || 'Manage your stock, track revenue, and monitor product performance'}
            </p>
          </div>
        </div>
        ...
        <div style={{
          ...
          <InventoryCard
            ...
            description={t('stockOverviewDesc') || 'View product stock levels, low stock alerts, and fast-moving items.'}
            icon={faBox}
            href="/dashboard/inventory/stock"
            color={COLORS.info}
          />
          <InventoryCard
            title={t('revenueOverview') || 'Revenue Overview'}
            description={t('revenueOverviewDesc') || 'See revenue per product and total earnings from delivered orders.'}
            icon={faMoneyBillWave}
            href="/dashboard/inventory/revenue"
            color={COLORS.primary}
          />
        </div>
      </div>

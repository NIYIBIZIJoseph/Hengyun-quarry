...
// ========== IMAGE MODAL (large close button) ==========
    ...
    <div>
      ...
      <section style={{ padding: "4rem 2rem", backgroundColor: COLORS.bgGray }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "2rem" }}>
          <div className="point-card"><h3>{t.goodPriceTitle}</h3><p>{t.goodPriceDesc}</p></div>
          <div className="point-card"><h3>{t.bestServicesTitle}</h3><p>{t.bestServicesDesc}</p></div>
          <div className="point-card"><h3>{t.quickDeliveryTitle}</h3><p>{t.quickDeliveryDesc}</p></div>
        </div>
      </section>
      ...
      <section style={{ padding: "4rem 2rem", backgroundColor: COLORS.bgWhite }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <h2 className="section-title">{id === "sand" ? t.sandProductsTitle : t.quarryProductsTitle}</h2>
          {products.length === 0 ? (
            <p style={{ textAlign: "center", color: COLORS.textSecondary }}>No products in this category yet.</p>
          ) : (
            <div style={{
              display: "grid",
